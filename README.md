...
| **Google Play** | 10 endpoints — search, full app detail (data safety, permission tree, legal entity, chart badge), reviews, permissions, similar apps, developer catalogue, category browse, top charts, categories, markets | [Google Play Docs](https://docs.scrapebadger.com/google-play/overview) |
| **App Store** | 7 endpoints — search, full app detail (iTunes + storefront histogram/IAP/App Privacy/full-res screenshots), reviews, developer profile + catalogue, top charts, genres, markets | [App Store Docs](https://docs.scrapebadger.com/app-store/overview) |
| **Google Ads Transparency** | 4 endpoints — creative search by advertiser/domain/free text, single-creative detail with every rendered variation, advertiser autocomplete, advertiser spend disclosure and ad mix | [Google Ads Docs](https://docs.scrapebadger.com/google/ads-overview) |
